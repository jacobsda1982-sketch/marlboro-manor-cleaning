...
const quoteLink = label => `<a class="button button-gold" href="${esc(business.quotePortalUrl)}" target="_blank" rel="noopener noreferrer">${esc(label)} <span aria-hidden="true">&rarr;</span></a>`

function serviceCards() {
  return `<div class="card-grid">${services.map(service => `<article class="card"><p class="eyebrow">Starting at ${service.price}</p><h3>${esc(service.name)}</h3><p>${esc(service.summary)}</p><a class="text-link" href="/services/${service.slug}/">Explore this service <span aria-hidden="true">&rarr;</span></a></article>`).join('')}</div>`
}
...
function previewImagery() {
  return `<section class="section brand-imagery" aria-labelledby="brand-imagery-title"><div class="container"><div class="section-heading"><div><p class="eyebrow">The manor aesthetic</p><h2 id="brand-imagery-title">Calm spaces. Thoughtful details.</h2></div><p>Our permanent brand imagery uses AI-generated interior concepts to express the visual character of Marlboro Manor Cleaning. It does not depict customer homes or completed company work.</p></div><div class="image-grid"><figure><div class="brand-image"><span class="brand-image-mark" aria-hidden="true">MM</span><img src="/images/testing/hero-synthetic-preview.webp" width="1800" height="899" alt="AI-generated brand concept of a calm cream and navy living room interior" loading="lazy"></div><figcaption>AI-generated Marlboro Manor brand concept â€” not a customer home or completed job.</figcaption></figure><figure><div class="brand-image"><span class="brand-image-mark" aria-hidden="true">MM</span><img src="/images/testing/kitchen-synthetic-preview.webp" width="1400" height="933" alt="AI-generated brand concept of a bright navy and cream kitchen interior" loading="lazy"></div><figcaption>AI-generated Marlboro Manor brand concept â€” not evidence of company work.</figcaption></figure></div></div></section>`
}
