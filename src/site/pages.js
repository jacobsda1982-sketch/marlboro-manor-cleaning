...
export const pages = [
  ...
  { path: '/my-service/', title: 'My Cleaning Service', description: 'Securely manage a Marlboro Manor Cleaning service journey.', eyebrow: 'Private service workspace', h1: 'Your cleaning, all in one place.', intro: 'Review progress, complete the next step, and contact your care coordinator.', servicePortal: true, noindex: true },
  { path: '/appointment/', title: 'Manage Your Cleaning Appointment', description: 'Securely confirm readiness or request a Marlboro Manor Cleaning appointment change.', eyebrow: 'Appointment management', h1: 'Manage your appointment.', intro: 'Review the confirmed visit, share readiness details, or request a change.', appointmentPortal: true, noindex: true },
  { path: '/payment/', title: 'Secure Payment Center', description: 'Securely manage the payment method and policy agreement for a Marlboro Manor Cleaning appointment.', eyebrow: 'Secure payment center', h1: 'Review your payment requirements.', intro: 'See the approved service amount, cancellation policy, and payment-method status.', paymentPortal: true, noindex: true },
  { path: '/feedback/', title: 'Share Service Feedback', description: 'Privately share feedback about a completed Marlboro Manor Cleaning service.', eyebrow: 'Service follow-up', h1: 'How did we do?', intro: 'Your feedback goes directly to the local care team.', feedbackPortal: true, noindex: true },
  { path: '/prepare/', title: 'Prepare for Your Cleaning', description: 'Securely share property-access and pet-handling instructions for a confirmed Marlboro Manor Cleaning appointment.', eyebrow: 'Secure visit preparation', h1: 'Prepare for your cleaning.', intro: 'Confirm who will be home, how the team should enter, and how pets will be kept comfortable and safe.', preparation: true, noindex: true },
  { path: '/crew/', title: 'Crew Work Opportunity', description: 'Securely review and respond to a Marlboro Manor Cleaning contractor work opportunity.', eyebrow: 'Contractor opportunity', h1: 'Review available work.', intro: 'Review the date, scope, and fixed payout, then tell operations whether you are interested.', crewOffer: true, noindex: true },
